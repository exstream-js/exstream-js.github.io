export const docsNavigation = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/docs/reference/pause/', label: 'pause()' },
      { href: '/docs/reference/resume/', label: 'resume()' },
      { href: '/docs/reference/end/', label: 'end()' },
      { href: '/docs/reference/destroy/', label: 'destroy()' },
      { href: '/docs/reference/abort/', label: 'abort()' },
      { href: '/docs/reference/fail/', label: 'fail()' },
      { href: '/docs/reference/extend/', label: 'extend()' },
      { href: '/docs/reference/utilities/', label: 'Utilities' },
    ],
  },
] as const
